...
from routers.utils import load_model, load_processor
...
async def transcribe_audio(
            ...
            processor = Depends(load_processor),
    ...
    return await transcription_service.transcribe(file, request, model, processor)