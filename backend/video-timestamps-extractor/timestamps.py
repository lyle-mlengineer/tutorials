...
class SQLRepository(BaseRepository):
    ...
    def save(self,  video_timestamps: VideoTimestampsDataset) -> None:
        video_model: VideoTimestampsDatasetDbModel = self.get(video_id=video_timestamps.video_id)
        video_model.timestamps = {'timestamps': [ timestamp.model_dump() for timestamp in video_timestamps.timestamps]}
...
class RedisQueueService:
    ...
    def _extract_timestamps(self, video_id: str) -> None:
        ...
        for match in matches:
            timestamp: Timestamp = RedisQueueService.get_timestamp_and_title(match.groups())
