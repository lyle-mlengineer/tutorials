...
from services import DatasetService, TimestampsExtractionService
...
def get_timestamps_extraction_service(db: Annotated[Session, Depends(get_db)]):
    return TimestampsExtractionService(db, youtube)